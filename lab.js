...
if(temperature >= 80 && rain === true) {
  console.log("Wear a t-shirt and grab an umbrella");
} else if(temperature >= 60 && temperature < 80 && rain === true) {
  console.log("Wear a rain-jacket");
} else if(temperature < 60 && rain === true) {
  console.log("Wear a jacket and grab an umbrella");
} else if(temperature >= 80 && rain === false) {
  console.log("T-shirts and flip flops it is!");
} else if (temperature >= 60 && temperature < 80 && rain === false) {
  console.log("I'd suggest pants and a long sleeve");
} else if(temperature < 60 && rain === false) {
  console.log("It's chilly, but at least it's not raining! Grab a jacket");
};
